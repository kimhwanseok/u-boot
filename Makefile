...
ifeq ($(ARCH),arm)
# To set up cross compiler for arm architecture, you should have to set shell
# env into your shell rc script, such as ~/.bashrc, like belows:-
#  export arch=ARM
#  export CROSS_COMPILE=/your/arm/cross/compiler/location/arm-non-linux-gnueabi-
...
ALL += $(obj)u-boot.srec $(obj)u-boot.bin $(obj)System.map $(U_BOOT_NAND) $(U_BOOT_ONENAND) $(obj)mkorigenspl
all:		$(ALL)

$(obj)mkorigenspl: $(obj)u-boot.bin
		$(HOSTCC) tools/mkorigenspl.c -o tools/mkorigenspl
		tools/mkorigenspl u-boot.bin origen-spl.bin
...
origen_android_config:	unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa9 origen insignal s5pc210
#########################################################################
## XScale Systems
#########################################################################
